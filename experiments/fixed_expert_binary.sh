#!/bin/bash
#SBATCH --job-name=A_fixed_expert_binary
#SBATCH --output=logs/%A/fixed_expert_binary_%A_%a.out
#SBATCH --error=logs/%A/fixed_expert_binary_%A_%a.err
#SBATCH --time=1:00:00
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
...
--persona_start ${START} \
--persona_end ${END} \
--output ../results/${EXP_NAME}/C_fairness_judgments_${START}_${END}.csv
