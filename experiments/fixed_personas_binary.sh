#!/bin/bash
#SBATCH --job-name=B_fixed_personas_binary
#SBATCH --output=logs/%A/fixed_personas_binary_%A_%a.out
#SBATCH --error=logs/%A/fixed_personas_binary_%A_%a.err
#SBATCH --time=5:00:00
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --cpus-per-task=4
#SBATCH --partition=gpu_test
#SBATCH --array=0  # 10 jobs with no limit on concurrent execution
...
EXP_NAME="fixed_personas_binary"
...
BATCH_SIZE=10
START=$((SLURM_ARRAY_TASK_ID * BATCH_SIZE + 991))
