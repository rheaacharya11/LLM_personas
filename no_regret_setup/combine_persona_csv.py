...
input_folder = "results/holdout_personas/"
output_folder = "multi_persona_data"
persona_file = "data/adult_personas.parquet"
...
csv_files = sorted([
    ...
    if f.startswith("fairness_judgments_") and f.endswith(".csv")
])
...
train_output_file = os.path.join(output_folder, "200_train_persona_judgments.csv")
