...
class FairnessElicitationAlgorithm:
    ...
    def load_constraint_sets(self, judge_id=None):
        ...
        if judge_id is not None:
            ...
            pairs_per_judge = 100  # Assuming 50 pairs were presented
            ...
            self.A =  1000  # A is the total number of pairs presented
    ...
    def cost_sensitive_oracle(self, costs):
        ...
        model = RandomForestClassifier(
            n_estimators=100,
            max_depth=8,  # optional — you can tune this!
            random_state=42
        )
    ...
    def plot_trajectory(self, results, gamma_values=None):
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig("RFtrajectory_plot.png")
        plt.show()
    ...
    def plot_pareto_curves(self, results):
        ...
        plt.grid(True)
        plt.savefig("RFpareto_curve.png")
        plt.show()
...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="train100_subset.parquet", 
                        help="Path to training data")
    parser.add_argument("--constraints_path", type=str, 
                        default="multi_persona_data/train_persona_judgments.json",
    ...
    import pickle
    with open(f"RFresults.pkl", "wb") as f:
